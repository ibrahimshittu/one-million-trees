...
import { Check, TreePine, TrendingUp, Award, Users, Sparkles, Heart, Leaf } from 'lucide-react'
...
export default function DonationSection() {
  ...
  return (
    <section id="donate" className="py-24 bg-gradient-to-b from-white via-green-50/30 to-white">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Every donation directly funds tree planting across Nigeria. Choose a package that matches 
            your commitment to environmental restoration and community development.
          </p>
        </motion.div>
                ...
                >
                  <Card 
                    className={`relative h-full transition-all duration-300 hover:shadow-2xl border-0 shadow-lg
                      ${tier.popular ? 'ring-2 ring-green-500 shadow-green-100 scale-105 z-10' : 'hover:-translate-y-2'}
                  ...
                  >
                    ...
                    <CardHeader className="text-center pb-6 pt-8">
                      <div className={`mx-auto mb-6 w-20 h-20 bg-gradient-to-br ${getTierColor(tier.id)} rounded-2xl flex items-center justify-center text-white shadow-lg`}>
                        {getTierIcon(tier.trees)}
                      </div>
                      <CardTitle className="text-2xl font-bold mb-2">{tier.name}</CardTitle>
                      <CardDescription className="text-base text-gray-600">
                        Plant {tier.trees} tree{tier.trees > 1 ? 's' : ''} in Nigeria
                      </CardDescription>
                    </CardHeader>
                    ...
                    <CardContent className="flex-grow px-6">
                      <div className="text-center mb-8">
                        ...
                        <p className="text-sm text-gray-500 mt-2">One-time donation</p>
                      </div>
          ...
          <TabsContent value="custom" className="mt-12">
            <Card className="max-w-2xl mx-auto shadow-xl border-0">
              <CardHeader className="text-center pb-8 pt-8 bg-gradient-to-br from-green-50 to-emerald-50">
                ...
                <CardTitle className="text-2xl font-bold">Custom Donation Amount</CardTitle>
                <CardDescription className="text-base mt-2">
                  Every ₦5,000 plants one tree. Choose any amount you're comfortable with.
                </CardDescription>
              </CardHeader>
                  ...
                  {customAmount && parseInt(customAmount) >= 5000 && (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-sm text-gray-600 mb-1">Your Impact</p>
                      ...
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        <div>
                          ...
                          <p className="font-semibold text-gray-900">
                            ~{Math.floor(parseInt(customAmount) / 5000) * 22} kg/year
                          </p>
                        </div>
                        <div>
                          <p className="text-gray-600">Oxygen Production</p>
                          <p className="font-semibold text-gray-900">
                            ~{Math.floor(parseInt(customAmount) / 5000) * 118} kg/year
                          </p>
                        </div>
                      </div>
                    </motion.div>
              ...
              <CardFooter className="px-8 pb-8">
                ...
                >
                  Donate ₦{customAmount ? parseInt(customAmount).toLocaleString() : '0'}
                </Button>
              </CardFooter>
            </Card>
          </TabsContent>
