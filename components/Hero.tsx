    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-b from-green-50 via-white to-green-50/30">
      ...
      <div className="container mx-auto px-4 z-10">
        ...
        >
          ...
          >
            Every tree planted helps combat climate change, prevents erosion,
            and creates a sustainable future for generations to come.
          </motion.p>
          ...
          >
            <Link href="#donate">
              <Button
                size="lg"
                className="text-lg px-8 py-6 bg-gradient-to-r from-green-600 to-green-500 hover:from-green-700 hover:to-green-600 shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all"
              >
                Donate Now
